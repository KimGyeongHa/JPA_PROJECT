...
public class FileDataReaderConfing {
    ...
    @Bean
    public Job fileDataReadJob(JobRepository jobRepository,Step fileDataReadStep){
    ...
    @Bean
    public Step fileDataReadStep(JobRepository jobRepository, ItemReader fileDataReader, PlatformTransactionManager platformTransactionManager){
